  ...
  collection :
  {
    ...
    items : [
        ...
        data : [
          ...
          { name: "image", value: "https://vignette.wikia.nocookie.net/lotr/images/3/3a/The_Lord_of_the_Rings_Characters.jpg/revision/latest?cb=20150328111911", prompt: "Image of the movies" }
        ]
	    },
	    {
        ...
        data : [
          ...
          { name: "image", value: "https://images-na.ssl-images-amazon.com/images/I/91ikvZgoHZL._SL1500_.jpg", prompt: "Image of the movies" }
        ]
	    },
	    {
        ...
        data : [
          ...
          { name: "image", value: "https://ugc.kn3.net/i/origin/http://elvortex.com/wp-content/uploads/2014/07/2994_game_of_thrones.jpg", prompt: "Image of the movies" }
        ]
	    }
    ]
  }
